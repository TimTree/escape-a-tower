...
function bonus() {
  ...
  main.innerHTML = "<p>Select a bonus feature from here.</p><ul id='moveon'><li onclick='gameLeaper()'><strong>Game Leaper</strong></li><li onclick='gamequiz()'><strong>Game Quiz</strong></li><li onclick='beatcreator()'><strong>Beat the Creator</strong></li><li onclick='qa()'>Q&A</li><li onclick='boxart()'>Escape a Tower Box Art</li><li onclick='journeytohome()'>The Sequel: Journey to Home</li><li onclick='vhistory()'>Version History</li><li onclick='recgames()'>Recommended Games</li><li onclick='bonusEverywhere()'>Bonus Features Everywhere</li></ul><div class='center'><p><span id ='prologueselect'><a onclick='imdone()'>Main&nbsp;Menu</a></span></p></div>";
  copyright.style.visibility = "hidden";
...
function reveal6() {
  document.getElementById("answer").innerHTML = "<p>Answer: A shard of light beams out.</p><div class='center'><p><a onclick='bonus()'>Back to Bonus Features</a></p></div>";
}
...
function boxart() {
  ...
  main.innerHTML = "<p>For a college psychology class, I studied how video game box art can persuade people to purchase games. It turns out many games have different box art for American and Japanese audiences.</p><p>American box art tends to invoke action and aggression to stimulate people's minds (Barratt & GamesRadar Staff, 2013; Gaston, 2014). Japanese box art, on the other hand, usually focuses on artistic qualities (Carlson, 2014; Haske, 2014).</p><p>To illustrate this finding, I drafted potential box art for Escape a Tower. To the left, the American version, and to the right, the Japanese version.</p><div class='center'><p><img src='./assets/img/TowerBoxArtUS.png' alt='Escape a Tower box art American' style='width:47%;max-width:300px;margin-right:2%;'><img src='./assets/img/TowerBoxArtJP.png' alt='Escape a Tower box art Japanese' style='width:47%;max-width:300px;'></p></div><p>For the American box art, I added an evocative kidnapper and a determined protagonist to showcase action. For the Japanese box art, I emphasized the tower for artistic purposes. <em>Which box art do you prefer?</em></p><p><strong>Works Cited</strong></p><div style='font-size:75%;text-indent:-7%;margin-left:7%;overflow-wrap: break-word;'><p>Barratt, C., & GamesRadar Staff. (2013, August 02). Japanese box art that's a billion times better than ours. Retrieved from <a href='https://www.gamesradar.com/why-japanese-box-art-is-better/' target='_blank' rel='noopener'>https://www.gamesradar.com/why-japanese-box-art-is-better/</a></p><p>Carlson, A. (2014, June 28). Video Game Box Art: America Is Getting Trounced By Japan. Retrieved from <a href='https://www.hardcoregamer.com/2014/06/28/video-game-box-art-america-is-getting-trounced-by-japan/91580/' target='_blank' rel='noopener'>https://www.hardcoregamer.com/2014/06/28/video-game-box-art-america-is-getting-trounced-by-japan/91580/</a></p><p>Gaston, M. (2014, April 28). Why is Kirby always angry in the US? Nintendo explains. Retrieved from <a href='https://www.gamespot.com/articles/why-is-kirby-always-angry-in-the-us-nintendo-explains/1100-6419263/' target='_blank' rel='noopener'>https://www.gamespot.com/articles/why-is-kirby-always-angry-in-the-us-nintendo-explains/1100-6419263/</a></p><p>Haske, S. (2014, February 01). The Coolest International Video Game Box Art. Retrieved from <a href='https://www.complex.com/pop-culture/2014/02/coolest-international-video-game-box-art/' target='_blank' rel='noopener'>https://www.complex.com/pop-culture/2014/02/coolest-international-video-game-box-art/</a></p></div><p><div class='center'><p><a onclick='bonus()'>Back to Bonus Features</a></p></div>";
}

function journeytohome() {
  titler.innerHTML = "The Sequel: Journey to Home";
  main.innerHTML = "<p>Here you can try the <strong>discontinued</strong> sequel <em>Journey to Home</em>, the quest back to your humble abode after escaping the tower.</p><p>The sequel would have added core enhancements like images for all scenes and a hint system. Ultimately, these features proved too ambitious for me to continue development.</p><p>That said, I don't want what I did develop to go to waste, so I'm releasing the first part of <em>Journey to Home</em>. I wrote most of the game in 2015, so what you see here may not reflect my current development practices.</p><div class='center'><div style='font-weight:700;font-size:150%;margin:1em 0 0.5em 0;'><a href='https://journeytohome.gamesbytim.com' target='_blank' rel='noopener'>Try Journey to Home</a></div></div><div class='center'><p><a onclick='bonus()'>Back to Bonus Features</a></p></div>";
}

function recgames() {
  titler.innerHTML = "Recommended Games";
  main.innerHTML = "<p>If you liked Escape a Tower, consider playing the following games.</p><p><strong>Escape the Tower</strong></p><p>A game with (almost) the same exact name! <a href='http://www.gamershood.com/escape_the_tower.htm' target='_blank' rel='noopener'>In this neat little Flash game</a>, you will need to rummage around a single room solving a complex puzzle in order to open the door.</p><p>Although Flash no longer works on the browser as of 2021, you can still run the game with the <a href='https://ruffle.rs/' target='_blank' rel='noopener'>Ruffle</a> browser extension.</p><p><strong>Visual novels</strong></p><p>Like this game, visual novels offer text-based storylines and difficult choices. Find out more on <a href='https://www.renpy.org' target='_blank' rel='noopener'>renpy.org</a> and the <a href='https://www.reddit.com/r/visualnovels' target='_blank' rel='noopener'>visual novels subreddit</a>.</p><p>I recommend playing <a href='https://hanakogames.com/magical_diary.shtml' target='_blank' rel='noopener'>Magical Diary</a> and <a href='https://en.wikipedia.org/wiki/Ace_Attorney' target='_blank' rel='noopener'>Phoenix Wright: Ace Attorney</a>.</p><p>Note: Some visual novels have adult content. Check the game's rating before you play!</p><p><strong>Choose Your Own Adventure books</strong></p><p><a href='https://www.cyoa.com' target='_blank' rel='noopener'>These classic books</a> have plenty of endings and entertainment. If you find any at your library, give them a try!</p><p><strong>Netflix Interactive Specials</strong></p><p>Did you know Netflix has films where you can make choices to alter the story? If you have a subscription, <a href='https://www.netflix.com/browse/genre/2869704' target='_blank' rel='noopener'>give them a shot!</a><p>Example interactive films include <a href='https://www.netflix.com/title/80988062' target='_blank' rel='noopener'>Black Mirror: Bandersnatch</a> and <a href='https://www.netflix.com/title/80994695' target='_blank' rel='noopener'>Carmen Sandiego: To Steal or Not To Steal</a>.</p></p><p><strong>Dunnet</strong></p><p><s>If you're on a Mac, there's a text adventure game built in your OS.</s> Type the following command in Terminal...</p><blockquote>emacs -batch -l dunnet</blockquote><p>...then go nuts.</p><p>Update: emacs is no longer included as of macOS 10.15 Catalina. You can still install emacs (and thus this game) using <a href='https://www.gnu.org/software/emacs/download.html#macos' target='_blank' rel='noopener'>these instructions.</a></p><div class='center'><p><a onclick='bonus()'>Back to Bonus Features</a></p></div>";
}
